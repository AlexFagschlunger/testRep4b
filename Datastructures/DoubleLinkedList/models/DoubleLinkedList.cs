...
namespace DoubleLinkedList.models
{
    class DoubleLinkedList<T> where T : class
    {
        ...
        public bool Add(T itemToAdd)
        {
            ...
            {
                this._lastItem.NextItem = new DoubleLinkedListItem<T>(itemToAdd, _lastItem, null);
        ...
        public bool AddAfter(T itemToAdd, T itemToFind)
        {
            ...
            {
                actItem.NextItem = new DoubleLinkedListItem<T>(itemToAdd, actItem, actItem.NextItem);
        ...
        public bool AddBefore(T itemToAdd, T itemToFind)
        {
            ...
            {
                actItem.BeforeItem = new DoubleLinkedListItem<T>(itemToAdd, null, actItem);
                this._firstItem = actItem.BeforeItem;
                return true;
            }
            else
            {
                actItem.BeforeItem = new DoubleLinkedListItem<T>(itemToAdd, actItem.BeforeItem, actItem);
                actItem.BeforeItem.BeforeItem.NextItem = actItem.BeforeItem;
                return true;
        ...
        public bool Remove(T itemToRemove)
        {
            ...
            {
                actItem.NextItem.BeforeItem = actItem.BeforeItem;
                actItem.BeforeItem.NextItem = actItem.NextItem;
                return true;
            }
